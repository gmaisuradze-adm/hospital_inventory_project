...
export class ProcurementService {
  ...
  async getProcurementById(id: string) {
    try {
      ...
      logger.error('Error fetching procurement request by ID:', error);
      throw new Error('Failed to fetch procurement request');
    }
  }

  async createProcurement(data: CreateProcurementData) {
    try {
      ...
      logger.info(`Procurement request created: ${request.id}`);
      return request;
    } catch (error) {
  ...
  async updateProcurement(id: string, data: UpdateProcurementData) {
    try {
      ...
      logger.info(`Procurement request updated: ${request.id}`);
      return request;
    } catch (error) {
  ...
  async deleteProcurement(id: string) {
    try {
      ...
      logger.info(`Procurement request deleted: ${id}`);
      return true;
    } catch (error) {
  ...
  async approveProcurement(id: string, approved: boolean, approvedBy: string, notes?: string) {
    try {
      ...
      logger.info(`Procurement request ${approved ? 'approved' : 'rejected'}: ${id}`);
      return request;
    } catch (error) {
  ...
  async updateProcurementStatus(
    ...
    try {
      ...
      logger.info(`Procurement status updated: ${id} to ${status}`);
      return request;
    } catch (error) {
      logger.error('Error updating procurement status:', error);
  ...
  async getProcurementStats() {
    try {
      ...
      logger.error('Error fetching procurement stats:', error);
      throw new Error('Failed to fetch procurement statistics');
    }
  }

  async getBudgetSummary(year?: number, quarter?: number) {
    try {
  ...
  async getProcurementsByCategory() {
    try {
      ...
      logger.error('Error fetching procurements by category:', error);
  ...
  async getProcurementsByDepartment() {
    try {
      ...
      logger.error('Error fetching procurements by department:', error);
  ...
  async getOverdueProcurements() {
    try {
      ...
      logger.error('Error fetching overdue procurements:', error);
  ...
  async submitForApproval(id: string) {
    try {
      ...
      logger.info(`Procurement request submitted for approval: ${id}`);
      return request;
    } catch (error) {
      logger.error('Error submitting procurement for approval:', error);
